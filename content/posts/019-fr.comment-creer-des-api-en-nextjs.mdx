---
title: Comprendre les API Routes et les Route Handlers dans Next.js
...
Contrairement aux Routes Handlers, les API Routes sont faciles à configurer et à comprendre surtout pour des développeurs qui ont déja eu à utiliser [Express](https://tailwindcss.com/). Mais les Routes handlers permettent de définir chaque méthode HTTP séparémment rendant le code plus lisible.
