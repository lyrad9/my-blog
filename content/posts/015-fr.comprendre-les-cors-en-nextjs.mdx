...
categories:
  - nextjs
published: true
bannerImage: https://lzdzy7eapvafpa4c.public.blob.vercel-storage.com/img_cors-ZFi8CEEYFDtxBWQfZayBGLCGwOT0fi.jpg
---

<MdxImage path="/corsBanner" title="dddddd" />
...
```typeScript showLineNumbers title="middleware.ts"
